...
## Load Packages                                                                 # On this side of the Code,I give the corresponding paragraphs 
# For a better overview, of where the packages where used, I included some       # to the text, to provide easy comparison
...
# Repository. However, I still included the code of the initial approach, as I 
...
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                                 ## Text Paragraphs:
## 7.4 - Model 2 and 3: Multiple Regressions ~~~                                 # 5.6 Regression Models
